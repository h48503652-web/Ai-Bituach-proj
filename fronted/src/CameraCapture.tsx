...
//           transition: 'opacity 0.3s ease-out', opacity: 0, animation: 'flash 0.3s'
//         }} />
//       )}
...
//               <div className="scanning-line" style={{ width: '100%', height: '2px', backgroundColor: 'rgba(37, 99, 235, 0.6)', position: 'absolute', top: '50%', boxShadow: '0 0 10px #2563eb' }} />
//             </div>
...
//             <button onClick={handleCancel} style={{
//               padding: '12px 24px', backgroundColor: 'transparent', color: 'white', borderRadius: '8px', border: '1px solid white', cursor: 'pointer'
//             }}>
//               ביטול
//             </button>
//             <button onClick={takePhoto} style={{
//               padding: '12px 40px', backgroundColor: '#2563eb', color: 'white', borderRadius: '30px', border: 'none', cursor: 'pointer', fontWeight: 'bold', fontSize: '18px', boxShadow: '0 4px 15px rgba(37, 99, 235, 0.4)'
//             }}>
//               📸 צלם
//             </button>
//           </div>
